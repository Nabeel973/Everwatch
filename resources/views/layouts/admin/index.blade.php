...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link text-center">
            {{--            <img src="{{asset('dist/img/Everwatch.png')}}" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">--}}
            <span class="brand-text font-weight-bold text-success">Everwatch</span>
        </a>
